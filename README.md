...
- 此分支的公开页面展示微信名片 `13751196386`；访客添加微信获取资料，不收集公开客户信息。
...
网站没有上传或公开分发第三方付费视频、PDF 和课程文件。此分支的公开领取流程为：访客添加微信 `13751196386` 获取资料；不需要完成登记，也不会在公开页面收集个人信息。历史记录仍由既有 D1、管理后台和导出能力处理。
